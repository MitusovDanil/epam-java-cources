                ...
                for (int x = 0; x < 4; x++)
                    for (int y = 0; y < 4; y++) {
                        if (productDigit[x] == startDigit[y]) {
                            ...
                            startDigit[y] = -2;
                            if (count == 4) {
                                if (product == 1435 || product == 1530 || product == 6880) {
                                    vampireNumbers.add(new VampireNumberImpl(product, num2, num1));
                                    continue;
                                }
                                vampireNumbers.add(new VampireNumberImpl(product, num1, num2));
                            }
                        }
                    }
            }
